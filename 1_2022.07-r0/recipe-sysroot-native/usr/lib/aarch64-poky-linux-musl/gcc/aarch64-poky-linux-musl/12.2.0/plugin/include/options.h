...
enum opt_code
{
  ...
  OPT_Wpoison_system_directories = 717,      /* -Wpoison-system-directories */
  ...
  OPT_fanalyzer_verbose_edges = 917,         /* -fanalyzer-verbose-edges */
  OPT_fanalyzer_verbose_state_changes = 918, /* -fanalyzer-verbose-state-changes */
  OPT_fanalyzer_verbosity_ = 919,            /* -fanalyzer-verbosity= */
  ...
  OPT_fasynchronous_unwind_tables = 928,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 929,                   /* -fauto-inc-dec */
  OPT_fauto_profile = 930,                   /* -fauto-profile */
  OPT_fauto_profile_ = 931,                  /* -fauto-profile= */
  OPT_fautomatic = 932,                      /* -fautomatic */
  OPT_fbackslash = 933,                      /* -fbackslash */
  OPT_fbacktrace = 934,                      /* -fbacktrace */
  OPT_fbit_tests = 935,                      /* -fbit-tests */
  OPT_fblas_matmul_limit_ = 936,             /* -fblas-matmul-limit= */
  OPT_fbounds_check = 937,                   /* -fbounds-check */
  OPT_fbounds_check_ = 938,                  /* -fbounds-check= */
  OPT_fbranch_count_reg = 939,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 940,           /* -fbranch-probabilities */
  /* OPT_fbranch_target_load_optimize = 941, *//* -fbranch-target-load-optimize */
  /* OPT_fbranch_target_load_optimize2 = 942, *//* -fbranch-target-load-optimize2 */
  /* OPT_fbtr_bb_exclusive = 943, */         /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 944,                /* -fbuilding-libgcc */
  OPT_fbuilding_libgfortran = 945,           /* -fbuilding-libgfortran */
  ...
  /* OPT_fcheck_assert = 966, */             /* -fcheck=assert */
  /* OPT_fcheck_bounds = 967, */             /* -fcheck=bounds */
  /* OPT_fcheck_in = 968, */                 /* -fcheck=in */
  /* OPT_fcheck_invariant = 969, */          /* -fcheck=invariant */
  /* OPT_fcheck_out = 970, */                /* -fcheck=out */
  /* OPT_fcheck_switch = 971, */             /* -fcheck=switch */
  OPT_fcheckaction_ = 972,                   /* -fcheckaction= */
  OPT_fchecking = 973,                       /* -fchecking */
  OPT_fchecking_ = 974,                      /* -fchecking= */
  OPT_fchkp_check_incomplete_type = 975,     /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 976,                /* -fchkp-check-read */
  OPT_fchkp_check_write = 977,               /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 978,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_flexible_struct_trailing_arrays = 979,/* -fchkp-flexible-struct-trailing-arrays */
  OPT_fchkp_instrument_calls = 980,          /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 981,    /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 982,             /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 983, /* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 984,                  /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 985,              /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 986,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 987, /* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 988,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 989,         /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 990,   /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 991,              /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 992,/* -fchkp-zero-input-bounds-for-main */
  /* OPT_fcilkplus = 993, */                 /* -fcilkplus */
  OPT_fcoarray_ = 994,                       /* -fcoarray= */
  OPT_fcode_hoisting = 995,                  /* -fcode-hoisting */
  OPT_fcombine_stack_adjustments = 996,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 997,                         /* -fcommon */
  OPT_fcompare_debug = 998,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 999,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 1000,                /* -fcompare-debug= */
  OPT_fcompare_elim = 1001,                  /* -fcompare-elim */
  OPT_fconcepts = 1002,                      /* -fconcepts */
  OPT_fconcepts_diagnostics_depth_ = 1003,   /* -fconcepts-diagnostics-depth= */
  OPT_fconcepts_ts = 1004,                   /* -fconcepts-ts */
  OPT_fcond_mismatch = 1005,                 /* -fcond-mismatch */
  /* OPT_fconserve_space = 1006, */          /* -fconserve-space */
  OPT_fconserve_stack = 1007,                /* -fconserve-stack */
  OPT_fconstant_string_class_ = 1008,        /* -fconstant-string-class= */
  OPT_fconstexpr_cache_depth_ = 1009,        /* -fconstexpr-cache-depth= */
  OPT_fconstexpr_depth_ = 1010,              /* -fconstexpr-depth= */
  OPT_fconstexpr_fp_except = 1011,           /* -fconstexpr-fp-except */
  OPT_fconstexpr_loop_limit_ = 1012,         /* -fconstexpr-loop-limit= */
  OPT_fconstexpr_ops_limit_ = 1013,          /* -fconstexpr-ops-limit= */
  OPT_fconvert_ = 1014,                      /* -fconvert= */
  OPT_fcoroutines = 1015,                    /* -fcoroutines */
  OPT_fcprop_registers = 1016,               /* -fcprop-registers */
  OPT_fcray_pointer = 1017,                  /* -fcray-pointer */
  OPT_fcrossjumping = 1018,                  /* -fcrossjumping */
  OPT_fcse_follow_jumps = 1019,              /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 1020, */         /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 1021,              /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 1022,              /* -fcx-limited-range */
  OPT_fd_lines_as_code = 1023,               /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 1024,           /* -fd-lines-as-comments */
  OPT_fdata_sections = 1025,                 /* -fdata-sections */
  OPT_fdbg_cnt_list = 1026,                  /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 1027,                      /* -fdbg-cnt= */
  OPT_fdce = 1028,                           /* -fdce */
  OPT_fdebug = 1029,                         /* -fdebug */
  OPT_fdebug_aux_vars = 1030,                /* -fdebug-aux-vars */
  OPT_fdebug_cpp = 1031,                     /* -fdebug-cpp */
  OPT_fdebug_prefix_map_ = 1032,             /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 1033,           /* -fdebug-types-section */
  OPT_fdebug_ = 1034,                        /* -fdebug= */
  OPT_fdec = 1035,                           /* -fdec */
  OPT_fdec_blank_format_item = 1036,         /* -fdec-blank-format-item */
  OPT_fdec_char_conversions = 1037,          /* -fdec-char-conversions */
  OPT_fdec_format_defaults = 1038,           /* -fdec-format-defaults */
  OPT_fdec_include = 1039,                   /* -fdec-include */
  OPT_fdec_intrinsic_ints = 1040,            /* -fdec-intrinsic-ints */
  OPT_fdec_math = 1041,                      /* -fdec-math */
  OPT_fdec_static = 1042,                    /* -fdec-static */
  OPT_fdec_structure = 1043,                 /* -fdec-structure */
  OPT_fdeclone_ctor_dtor = 1044,             /* -fdeclone-ctor-dtor */
  /* OPT_fdeduce_init_list = 1045, */        /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 1046,              /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 1047, */          /* -fdefault-inline */
  OPT_fdefault_integer_8 = 1048,             /* -fdefault-integer-8 */
  OPT_fdefault_real_10 = 1049,               /* -fdefault-real-10 */
  OPT_fdefault_real_16 = 1050,               /* -fdefault-real-16 */
  OPT_fdefault_real_8 = 1051,                /* -fdefault-real-8 */
  OPT_fdefer_pop = 1052,                     /* -fdefer-pop */
  OPT_fdelayed_branch = 1053,                /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 1054,        /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 1055,    /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 1056,                  /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 1057,        /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 1058,    /* -fdevirtualize-speculatively */
  /* OPT_fdiagnostics_color = 1059, */       /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 1060,            /* -fdiagnostics-color= */
  OPT_fdiagnostics_column_origin_ = 1061,    /* -fdiagnostics-column-origin= */
  OPT_fdiagnostics_column_unit_ = 1062,      /* -fdiagnostics-column-unit= */
  OPT_fdiagnostics_escape_format_ = 1063,    /* -fdiagnostics-escape-format= */
  OPT_fdiagnostics_format_ = 1064,           /* -fdiagnostics-format= */
  OPT_fdiagnostics_generate_patch = 1065,    /* -fdiagnostics-generate-patch */
  OPT_fdiagnostics_minimum_margin_width_ = 1066,/* -fdiagnostics-minimum-margin-width= */
  OPT_fdiagnostics_parseable_fixits = 1067,  /* -fdiagnostics-parseable-fixits */
  OPT_fdiagnostics_path_format_ = 1068,      /* -fdiagnostics-path-format= */
  OPT_fdiagnostics_plain_output = 1069,      /* -fdiagnostics-plain-output */
  OPT_fdiagnostics_show_caret = 1070,        /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_cwe = 1071,          /* -fdiagnostics-show-cwe */
  OPT_fdiagnostics_show_labels = 1072,       /* -fdiagnostics-show-labels */
  OPT_fdiagnostics_show_line_numbers = 1073, /* -fdiagnostics-show-line-numbers */
  OPT_fdiagnostics_show_location_ = 1074,    /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 1075,       /* -fdiagnostics-show-option */
  OPT_fdiagnostics_show_path_depths = 1076,  /* -fdiagnostics-show-path-depths */
  OPT_fdiagnostics_show_template_tree = 1077,/* -fdiagnostics-show-template-tree */
  OPT_fdiagnostics_urls_ = 1078,             /* -fdiagnostics-urls= */
  OPT_fdirectives_only = 1079,               /* -fdirectives-only */
  OPT_fdisable_ = 1080,                      /* -fdisable- */
  OPT_fdoc = 1081,                           /* -fdoc */
  OPT_fdoc_dir_ = 1082,                      /* -fdoc-dir= */
  OPT_fdoc_file_ = 1083,                     /* -fdoc-file= */
  OPT_fdoc_inc_ = 1084,                      /* -fdoc-inc= */
  OPT_fdollar_ok = 1085,                     /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 1086,        /* -fdollars-in-identifiers */
  OPT_fdruntime = 1087,                      /* -fdruntime */
  OPT_fdse = 1088,                           /* -fdse */
  OPT_fdump_ = 1089,                         /* -fdump- */
  OPT_fdump_ada_spec = 1090,                 /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 1091,            /* -fdump-ada-spec-slim */
  OPT_fdump_analyzer = 1092,                 /* -fdump-analyzer */
  OPT_fdump_analyzer_callgraph = 1093,       /* -fdump-analyzer-callgraph */
  OPT_fdump_analyzer_exploded_graph = 1094,  /* -fdump-analyzer-exploded-graph */
  OPT_fdump_analyzer_exploded_nodes = 1095,  /* -fdump-analyzer-exploded-nodes */
  OPT_fdump_analyzer_exploded_nodes_2 = 1096,/* -fdump-analyzer-exploded-nodes-2 */
  OPT_fdump_analyzer_exploded_nodes_3 = 1097,/* -fdump-analyzer-exploded-nodes-3 */
  OPT_fdump_analyzer_exploded_paths = 1098,  /* -fdump-analyzer-exploded-paths */
  OPT_fdump_analyzer_feasibility = 1099,     /* -fdump-analyzer-feasibility */
  OPT_fdump_analyzer_json = 1100,            /* -fdump-analyzer-json */
  OPT_fdump_analyzer_state_purge = 1101,     /* -fdump-analyzer-state-purge */
  OPT_fdump_analyzer_stderr = 1102,          /* -fdump-analyzer-stderr */
  OPT_fdump_analyzer_supergraph = 1103,      /* -fdump-analyzer-supergraph */
  OPT_fdump_analyzer_untracked = 1104,       /* -fdump-analyzer-untracked */
  OPT_fdump_c___spec_verbose = 1105,         /* -fdump-c++-spec-verbose */
  OPT_fdump_c___spec_ = 1106,                /* -fdump-c++-spec= */
  /* OPT_fdump_core = 1107, */               /* -fdump-core */
  OPT_fdump_d_original = 1108,               /* -fdump-d-original */
  OPT_fdump_final_insns = 1109,              /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 1110,             /* -fdump-final-insns= */
  OPT_fdump_fortran_global = 1111,           /* -fdump-fortran-global */
  OPT_fdump_fortran_optimized = 1112,        /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 1113,         /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 1114,                 /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 1115,       /* -fdump-internal-locations */
  OPT_fdump_noaddr = 1116,                   /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 1117, */         /* -fdump-parse-tree */
  OPT_fdump_passes = 1118,                   /* -fdump-passes */
  OPT_fdump_scos = 1119,                     /* -fdump-scos */
  OPT_fdump_unnumbered = 1120,               /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 1121,         /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 1122,                /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 1123,                /* -fearly-inlining */
  OPT_felide_constructors = 1124,            /* -felide-constructors */
  OPT_felide_type = 1125,                    /* -felide-type */
  /* OPT_feliminate_dwarf2_dups = 1126, */   /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 1127,/* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 1128,  /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 1129,       /* -femit-class-debug-always */
  OPT_femit_struct_debug_baseonly = 1130,    /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 1131,   /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 1132,     /* -femit-struct-debug-reduced */
  OPT_fenable_ = 1133,                       /* -fenable- */
  OPT_fenforce_eh_specs = 1134,              /* -fenforce-eh-specs */
  OPT_fenum_int_equiv = 1135,                /* -fenum-int-equiv */
  OPT_fexceptions = 1136,                    /* -fexceptions */
  OPT_fexcess_precision_ = 1137,             /* -fexcess-precision= */
  OPT_fexec_charset_ = 1138,                 /* -fexec-charset= */
  OPT_fexpensive_optimizations = 1139,       /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 1140,          /* -fext-numeric-literals */
  OPT_fextended_identifiers = 1141,          /* -fextended-identifiers */
  OPT_fextern_std_ = 1142,                   /* -fextern-std= */
  OPT_fextern_tls_init = 1143,               /* -fextern-tls-init */
  OPT_fexternal_blas = 1144,                 /* -fexternal-blas */
  OPT_fexternal_templates = 1145,            /* -fexternal-templates */
  OPT_ff2c = 1146,                           /* -ff2c */
  OPT_ffast_math = 1147,                     /* -ffast-math */
  OPT_ffat_lto_objects = 1148,               /* -ffat-lto-objects */
  OPT_ffile_prefix_map_ = 1149,              /* -ffile-prefix-map= */
  OPT_ffinite_loops = 1150,                  /* -ffinite-loops */
  OPT_ffinite_math_only = 1151,              /* -ffinite-math-only */
  OPT_ffixed_ = 1152,                        /* -ffixed- */
  OPT_ffixed_form = 1153,                    /* -ffixed-form */
  OPT_ffixed_line_length_ = 1154,            /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 1155,        /* -ffixed-line-length-none */
  OPT_ffloat_store = 1156,                   /* -ffloat-store */
  OPT_ffold_simple_inlines = 1157,           /* -ffold-simple-inlines */
  OPT_ffor_scope = 1158,                     /* -ffor-scope */
  /* OPT_fforce_addr = 1159, */              /* -fforce-addr */
  OPT_fforward_propagate = 1160,             /* -fforward-propagate */
  OPT_ffp_contract_ = 1161,                  /* -ffp-contract= */
  OPT_ffp_int_builtin_inexact = 1162,        /* -ffp-int-builtin-inexact */
  OPT_ffpe_summary_ = 1163,                  /* -ffpe-summary= */
  OPT_ffpe_trap_ = 1164,                     /* -ffpe-trap= */
  OPT_ffree_form = 1165,                     /* -ffree-form */
  OPT_ffree_line_length_ = 1166,             /* -ffree-line-length- */
  OPT_ffree_line_length_none = 1167,         /* -ffree-line-length-none */
  OPT_ffreestanding = 1168,                  /* -ffreestanding */
  OPT_ffriend_injection = 1169,              /* -ffriend-injection */
  OPT_ffrontend_loop_interchange = 1170,     /* -ffrontend-loop-interchange */
  OPT_ffrontend_optimize = 1171,             /* -ffrontend-optimize */
  OPT_ffunction_cse = 1172,                  /* -ffunction-cse */
  OPT_ffunction_sections = 1173,             /* -ffunction-sections */
  OPT_fgcse = 1174,                          /* -fgcse */
  OPT_fgcse_after_reload = 1175,             /* -fgcse-after-reload */
  OPT_fgcse_las = 1176,                      /* -fgcse-las */
  OPT_fgcse_lm = 1177,                       /* -fgcse-lm */
  OPT_fgcse_sm = 1178,                       /* -fgcse-sm */
  OPT_fgimple = 1179,                        /* -fgimple */
  OPT_fgnat_encodings_ = 1180,               /* -fgnat-encodings= */
  OPT_fgnu_keywords = 1181,                  /* -fgnu-keywords */
  OPT_fgnu_runtime = 1182,                   /* -fgnu-runtime */
  OPT_fgnu_tm = 1183,                        /* -fgnu-tm */
  OPT_fgnu_unique = 1184,                    /* -fgnu-unique */
  OPT_fgnu89_inline = 1185,                  /* -fgnu89-inline */
  OPT_fgo_c_header_ = 1186,                  /* -fgo-c-header= */
  OPT_fgo_check_divide_overflow = 1187,      /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 1188,          /* -fgo-check-divide-zero */
  OPT_fgo_compiling_runtime = 1189,          /* -fgo-compiling-runtime */
  OPT_fgo_debug_escape = 1190,               /* -fgo-debug-escape */
  OPT_fgo_debug_escape_hash_ = 1191,         /* -fgo-debug-escape-hash= */
  OPT_fgo_debug_optimization = 1192,         /* -fgo-debug-optimization */
  OPT_fgo_dump_ = 1193,                      /* -fgo-dump- */
  OPT_fgo_embedcfg_ = 1194,                  /* -fgo-embedcfg= */
  OPT_fgo_optimize_ = 1195,                  /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 1196,                   /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 1197,                    /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 1198,      /* -fgo-relative-import-path= */
  OPT_fgraphite = 1199,                      /* -fgraphite */
  OPT_fgraphite_identity = 1200,             /* -fgraphite-identity */
  OPT_fguess_branch_probability = 1201,      /* -fguess-branch-probability */
  OPT_fguiding_decls = 1202,                 /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 1203, */       /* -fhandle-exceptions */
  OPT_fharden_compares = 1204,               /* -fharden-compares */
  OPT_fharden_conditional_branches = 1205,   /* -fharden-conditional-branches */
  /* OPT_fhelp = 1206, */                    /* -fhelp */
  /* OPT_fhelp_ = 1207, */                   /* -fhelp= */
  OPT_fhoist_adjacent_loads = 1208,          /* -fhoist-adjacent-loads */
  OPT_fhonor_std = 1209,                     /* -fhonor-std */
